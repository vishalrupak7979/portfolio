      ...
      <div className="projects">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://www.app.zita.ai/login/?next=/"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              <h3>AI-Powered Recruitment Software – Zita ATS</h3>
              <p>
                {" "}
                Developed Zita ATS, an AI-powered recruitment software built
                with React.js, enabling employers to match job descriptions with
                candidate skills. The system calculates a compatibility
                percentage, helping recruiters identify the most suitable
                candidates, schedule interviews, and streamline the hiring
                process efficiently.
              </p>
            </div>
            <footer>
              ...
              <ul className="tech-list">
                {" "}
                <li>Reactjs</li> <li>Redux</li> <li>Bootstrap</li>{" "}
              </ul>{" "}
            </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://www.zita.ai/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Zita ATS Website – Feature Showcase & Knowledge Base</h3>
              <p>
                Developed a website for Zita ATS to showcase its features and
                provide a knowledge base for users. Built with React.js, the
                website was later migrated to Next.js for server-side rendering
                (SSR) and improved performance. Additionally, Node Mailer was
                integrated to handle inquiries from the Contact Us form
                efficiently.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Zita Standalone API – Usage & Analytics Dashboard</h3>
              <p>
                Worked on the Zita Standalone API, which provides Zita's
                application APIs as a service for a specific charge. Developed a
                dashboard using React.js to display daily and monthly API usage,
                purchase logs, and other key insights, helping users track their
                API consumption and manage their subscriptions efficiently.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>InnovSpace – Co-Working Space Website</h3>
              <p>
                Developed the InnovSpace website using React.js to showcase
                co-working space rental services. Later, migrated the website to
                Next.js to enhance performance with server-side rendering (SSR)
                and improve SEO, ensuring a seamless and optimized user
                experience.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Sense7ai Website – Maintenance & Enhancements</h3>
              <p>
                Performed comprehensive maintenance on the Sense7ai website by
                updating page content, launching a new blog section, and
                integrating social media sharing and SEO plugins to boost
                engagement and improve search engine visibility.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Wordpress</li>
                <li>Social Media Sharing Plugin</li>
                <li>SEO Plugin</li>
              </ul>
            </footer>
          </div>
